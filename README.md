...
- **Home** (`/`) — hero, services-grid, features, gallery, testimonials, process, cta, contact-preview
- **Services** (`/services`) — hero, services-detail, services-detail, services-detail
- **About** (`/about`) — hero, story, team, certifications
- **Contact** (`/contact`) — hero, contact-form, contact-info, map
...
git clone https://github.com/CyberParv/proj_mlvgakat.git
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/CyberParv/proj_mlvgakat)
